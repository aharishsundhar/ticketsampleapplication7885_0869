...
APPLICATION='/ticketsampleapplication7885'
...
DESKTOPIMAGENAME='geppettotest/ticketsampleapplication7885-desktop:1.0'
...
helm install --name ticketsampleapplication7885-0869 ./helm
if [ $? -eq 0 ]; then
